...
pub struct SessionHeader {
    ...
    pub recv_len: usize,
    /// Handshake summary of the TLS session between Prover and Server
...
impl SessionHeader {
    ...
    pub fn verify(
        ...
        println!("self.handshake_summary.handshake_commitment(): {:?}", self.handshake_summary.handshake_commitment());
